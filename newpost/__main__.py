...
# Created by Josh Branchard: https://github.com/jbranchaud/mybin/blob/master/jekyll-post
# Modified by lukasschwab:
#   + Lowercases text in filename
#   + Default to _posts subdir of jekyll root dir
...
def main():
    ...
    if args.Dir:
        ...
        if os.path.exists('_posts'):
            ...
            print 'No _posts directory; specify with -D.'
            sys.exit(1)
